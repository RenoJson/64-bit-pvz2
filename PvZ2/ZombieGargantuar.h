...
class ZombieMausoleumGargantuar : public ZombieGargantuar
{
public:
	static void* vftable;
	static Sexy::RtClass* s_rtClass;
	...
	RT_CLASS_CONSTRUCT_FUNCTION_BEGIN(ZombieMausoleumGargantuar, 0xC3AB1C);
	RT_CLASS_CONSTRUCT_FUNCTION_END();

	RT_CLASS_BUILD_SYMBOLS_BEGIN(ZombieGargantuar);
	RT_CLASS_BUILD_SYMBOLS_END();

	RT_CLASS_REGISTER_CLASS_FUNCTION(ZombieMausoleumGargantuar);
	RT_CLASS_GET_CLASS_FUNCTION(ZombieMausoleumGargantuar, 0xB53840);
};
