...
class ZombieAnimRig_MausoleumAssasin : public ZombieAnimRig_MausoleumBasic
{
public:
	bool m_hasScroll;
	bool m_hasDagger;
	...
	RT_CLASS_GET_CLASS_NO_PARENT_ADDRESS_CLASS_FUNCTION(ZombieAnimRig_MausoleumAssasin, ZombieAnimRig_MausoleumBasic::StaticGetType);
};