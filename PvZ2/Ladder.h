...
public:
	...
	RT_CLASS_REGISTER_CLASS_RTWEAKPTR_PROPERTY(ZombieLadder, m_attachedPlant, Sexy::RtObject)
	RT_CLASS_REGISTER_RTWEAKPTR_VECTOR_PROPERTY(ZombieLadder, m_climbingZombies, Sexy::RtObject)
