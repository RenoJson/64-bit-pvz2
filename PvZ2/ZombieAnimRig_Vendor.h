...
class ZombieAnimRig_Piggy : public ZombieAnimRig
{
public:
	static void* vftable;
	static Sexy::RtClass* s_rtClass;
	...
	RT_CLASS_CONSTRUCT_FUNCTION_BEGIN(ZombieAnimRig_Piggy, 0x9D9C4C);
	RT_CLASS_CONSTRUCT_FUNCTION_END();

	RT_CLASS_BUILD_SYMBOLS_BEGIN(ZombieAnimRig);
	RT_CLASS_BUILD_SYMBOLS_END();

	RT_CLASS_REGISTER_CLASS_FUNCTION(ZombieAnimRig_Piggy);
	RT_CLASS_GET_CLASS_FUNCTION(ZombieAnimRig_Piggy, 0x8DBB70);
};
